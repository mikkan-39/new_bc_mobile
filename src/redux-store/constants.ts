...
export const FETCH_TABLES_FOR_TICKET_REQUEST =
  "FETCH_TABLES_FOR_TICKET_REQUEST";
export const CLEAR_TICKET_STORAGE = "CLEAR_TICKET_STORAGE";
export const CLEAR_ASYNC_STORAGE = "CLEAR_ASYNC_STORAGE";
export const EDIT_TICKET_FIELD = "EDIT_TICKET_FIELD";
export const EDIT_TICKET_TABLE = "EDIT_TICKET_TABLE";
