...
import { Editorinconfig, TicketResponse, ExtendedControl } from "../../redux-store/helpers";
import { RootState } from "../../redux-store/store";

export const addLinksToEditorControls = (ticket: TicketResponse, editor: Editorinconfig) => {
...
export const generateNecessaryLinks = (ticket: TicketResponse, editor: Editorinconfig, tablesInStorage: any) => {
